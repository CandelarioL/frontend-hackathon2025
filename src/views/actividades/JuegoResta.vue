  ...
  >
    ...
    >
      ...
      <h2 class="text-2xl font-semibold text-gray-800 mb-8">
        Resta los números y observa las pistas 👀
      </h2>
      ...
      <div class="flex justify-center flex-wrap gap-3 mb-8">
        <div v-for="n in resultadoPositivo" :key="n" class="text-4xl">
          {{ iconoAleatorio() }}
        </div>
      </div>
...
export default {
  ...
  methods: {
    generarNumero() {
      // Generar números entre 1 y 9 asegurando que el resultado no sea negativo
    ...
    verificar() {
      ...
      if (parseInt(this.respuesta) === correcta) {
        ...
        this.mensajeMascota =
          "🎉 ¡Muy bien! ¡Eres un genio de las restas! 🐾💫";
    ...
    leerInstruccion() {
      const texto = `Atención: Resta ${this.numero2} a ${this.numero1} y escribe el resultado.`;
